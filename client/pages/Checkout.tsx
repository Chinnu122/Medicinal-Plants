...
export default function Checkout() {
  ...
  const discountAmount = appliedOfferCode ? getDiscountAmount(appliedOfferCode, subtotal) : 0;
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button 
                      ...
                      disabled={!shippingData.name || !shippingData.street || !shippingData.city || !shippingData.state || !shippingData.zipCode}
                    >
                      Continue to Payment
                    </Button>
                  </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button 
                        ...
                        disabled={paymentData.method === 'credit_card' && (!paymentData.cardNumber || !paymentData.expiryDate || !paymentData.cvv)}
                      >
                        Review Order
                      </Button>
                    </div>
                      ...
                      <div className="space-y-2">
                        {items.map((item) => (
                          <div key={item.id} className="flex justify-between items-center p-2 bg-muted/50 rounded">
                            <div>
                              <span className="font-medium">{item.plant.name}</span>
